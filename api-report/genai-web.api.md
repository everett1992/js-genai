...
export namespace Interactions {
    ...
    // Warning: (ae-forgotten-export) The symbol "AgentSecurityRequest$" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    ...
    // Warning: (ae-forgotten-export) The symbol "FileContent$" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
